...
const FAQS = () => {
  ...
  const faqs = [
    {
      question: 'How does Swasthya Darpan AI accelerate drug discovery?',
      answer: 'Swasthya Darpan AI leverages advanced machine learning algorithms to analyze vast datasets of molecular structures, biological pathways, and clinical outcomes, significantly reducing the time and cost of identifying promising drug candidates.',
    },
    {
      question: 'What types of data can Swasthya Darpan AI analyze for biomedical research?',
    ...
    {
      question: 'How does Swasthya Darpan AI support target identification?',
      answer: 'Swasthya Darpan AI employs sophisticated algorithms to analyze complex biological networks and disease pathways, helping researchers discover and validate novel therapeutic targets with a higher probability of clinical success.',
    },
    {
      question: 'Can Swasthya Darpan AI assist with molecular modeling and simulation?',
    ...
    {
      question: 'How does Swasthya Darpan AI contribute to precision medicine?',
      answer: 'Swasthya Darpan AI analyzes patient-specific data to develop tailored treatment strategies, optimizing drug efficacy and minimizing adverse effects based on individual genetic profiles and biomarkers.',
    },
    {
      question: 'What is Swasthya Darpan AIs approach to drug repurposing?',
    ...
    {
      question: 'How secure is the data processed by Swasthya Darpan AI?',
    ...
    {
      question: 'Can Swasthya Darpan AI integrate with existing research tools and databases?',
