        ...
        <div className="flex justify-between items-center w-full h-full">
          <div className="flex">
            <Link href="/" className="flex items-center gap-2 font-semibold text-lg hover:opacity-80 transition-opacity duration-200">
              ...
              <span className="bg-clip-text bg-gradient-to-r from-purple-500 via-fuchsia-500 to-indigo-500 font-extrabold text-2xl text-transparent animate-gradient">
                Swasthya Darpan
              </span>
            </Link>
          </div>
          <div className="flex items-center gap-4">
            {user ? (
              <>
                <Link href="/dashboard/molecule-bank" className={`${buttonVariants({ size: "sm" })} bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 hover:from-blue-600 hover:via-indigo-600 hover:to-purple-600 text-white font-bold py-2 px-4 rounded-full transform hover:scale-105 transition-all duration-200 shadow-lg`}>
              ...
              <>
                ...
                <Link href="/dashboard/molecule-bank" className={`${buttonVariants({ size: "sm" })} bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 hover:from-indigo-600 hover:via-purple-600 hover:to-pink-600 text-white font-bold py-2 px-4 rounded-full transform hover:scale-105 transition-all duration-200 shadow-lg`}>
