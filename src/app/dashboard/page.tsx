...
const DashboardPage = async () => {
    ...
    // Mock symptoms and medications data for the Recommendations component
    const symptoms = dbUser.symptoms;
    const medications = dbUser.medications;
